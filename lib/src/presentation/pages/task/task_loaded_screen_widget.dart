...
class TaskLoadedScreenWidget extends StatefulWidget {
  const TaskLoadedScreenWidget({
    required this.task,
    Key? key,
  }) : super(key: key);
  ...
  @override
  State<TaskLoadedScreenWidget> createState() => _TaskLoadedScreenWidgetState();
}

class _TaskLoadedScreenWidgetState extends State<TaskLoadedScreenWidget> {
  void _onSaveButton() {
  ...
  final Completer completer = Completer<TaskModel>();
